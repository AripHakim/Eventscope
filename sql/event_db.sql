...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1995344802ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=event_db&table=kontak">`event_db`.`kontak`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=event_db&table=events">`event_db`.`events`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=eventdb&table=events">`eventdb`.`events`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2d74295a75664f4567417727225a344c">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="event_db" targettable="events">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `events`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="eventdb" targettable="events">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `events`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="event_db" targettable="kontak">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `kontak`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="event_db" targettable="events">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `events`  
ORDER BY `events`.`tanggalWaktu` ASC</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE events
ADD harga VARCHAR(255);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="event_db" targettable="events">
                            <div class="action_content">
